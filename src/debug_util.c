...
#if defined(_TARGET_ARMV7L)
#define PATH_MEMCHECK "/home/developer/sdk_tools/valgrind/usr/lib/valgrind/memcheck-arm-linux"
#elif defined(_TARGET_X86)
#define PATH_MEMCHECK "/home/developer/sdk_tools/valgrind/usr/lib/valgrind/memcheck-x86-linux"
#elif defined(_TARGET_AARCH64)
#define PATH_MEMCHECK "/home/developer/sdk_tools/valgrind/usr/lib64/valgrind/memcheck-arm64-linux"
#elif defined(_TARGET_X86_64)
#define PATH_MEMCHECK "/home/developer/sdk_tools/valgrind/usr/lib64/valgrind/memcheck-amd64-linux"
#endif
...
static int __check_pkginfo(const char *appid)
{
	...
	if (preload == true || storeclientid[0] != '\0') {
...
static int __prepare_valgrind(bundle *kb)
{
	...
	for (i = 0; i < len; i++) {
		...
		if (strncmp(str_arr[i], OPT_VALGRIND_LOGFILE_FIXED, strlen(str_arr[i])) == 0) {
